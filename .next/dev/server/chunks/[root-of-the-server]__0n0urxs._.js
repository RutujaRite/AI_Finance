...
async function GET(req) {
    ...
    const payload = token ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token) : null;
    if (!payload) {
    ...
    try {
        const res = await client.query("SELECT id, name, email, role FROM users WHERE id = $1 LIMIT 1", [
            payload.id
        ]);
        if (res.rowCount === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0n0urxs._.js.map