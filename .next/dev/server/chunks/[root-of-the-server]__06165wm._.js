...
async function GET(req) {
    const all = Array.from(conversations.values()).sort((a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06165wm._.js.map