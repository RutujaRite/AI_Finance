...
// Inlined from lib/ai/prompts.ts (single source of truth is the .ts file)
const BANK_MANAGER_ASSISTANT_PROMPT = `You are a banking and loan assistant for InCraax AI.
...
async function processUserMessage(
  ...
  const messages = [
    { role: 'system', content: BANK_MANAGER_ASSISTANT_PROMPT },
    ...conversationHistory,
